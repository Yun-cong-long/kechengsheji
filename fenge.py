...
def split_bmp_image(input_path, output_dir, tile_width=512, tile_height=512):
    """
    将大尺寸BMP图片分割成指定大小的小图片
...
def main():
    """主函数"""
    parser = argparse.ArgumentParser(description='分割大尺寸BMP图片成多个512x512的小图片')
    parser.add_argument('input_file', help='输入的BMP文件路径')
    parser.add_argument('-o', '--output', default='output_tiles', 
                       help='输出目录 (默认: output_tiles)')
...
if __name__ == "__main__":
    ...
    # split_bmp_image(input_image, output_directory)
